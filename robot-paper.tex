...
\author[
   ...
   email={rctauber@gmail.com}   % email address
]{\inits{J}\fnm{Rebecca} \snm{Tauber}}

\author[
   addressref={rti},                   % id's of addresses, e.g. {aff1,aff2}
   email={balhoff@renci.org}   % email address
]{\inits{J}\fnm{James} \snm{Balhoff}}


\author[
   addressref={lbl},                   % id's of addresses, e.g. {aff1,aff2}
   email={edouglass@lbl.gov}   % email address
]{\fnm{Eric} \snm{Douglass}}
...
]{\inits{J}\fnm{James A} \snm{Overton}}
...
\bibliography{robot-paper}      % Bibliography file (usually '*.bib' )
